...
public class CreateScorecardIniativeKPIStepDefinition implements En {
	...
	public CreateScorecardIniativeKPIStepDefinition(TestContext testContext) throws Exception {
		...
		{
			createKpi.ClickRadio_AggregateType2();
		});
