@44_CreateScorecardGroupKpi
Feature: Create and publish CreateScorecardGroupKpi
  Description: In order to ensure CreateScorecardGroupKpi Functionality Feature works, I want to run the cucumber test to verify it is working
  ...
  @CreateScorecardGroupKpi @Smoke
  Scenario: To test create and publish CreateScorecardGroupKpi works as expected
