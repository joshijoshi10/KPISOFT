@45_ForceCloseByUser
Feature: Force Close By User feature
 Description: In order to ensure Force Close By User Functionality Feature works, I want to use this template for my feature file
...
Background:
  ...
  #@Smoke
  Scenario: To test Force Close By User works as expected
