@MeasureKPIQuarterly
Feature: Create and publish performance program with Measure KPI Quarterly
  ...
  #@MeasureKPIQuarterly @Smoke
  Scenario: To test create and publish performance program with Measure KPI Quarterly works as expected
